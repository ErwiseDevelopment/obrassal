...
function single_temas_scripts()
{
    ...
    wp_enqueue_script('single-temas-progress-bar', get_template_directory_uri() . '/../wp-bootstrap-starter-child/assets/js/progress-bar.js', array(), '1.0.2', true);
    ...
    //wp_enqueue_script('single-temas-countup', get_template_directory_uri() . '/../wp-bootstrap-starter-child/assets/js/countUp.ts', array(), '1.0.2', true);
    //wp_enqueue_script('single-temas-count-number', get_template_directory_uri() . '/../wp-bootstrap-starter-child/assets/js/count-number.js', array(), '1.0.2', true);
...
function add_read_more($string, $word_limit, $count) {
    $words = explode(' ', $string, ($word_limit + 1));  
    
    if(count($words) > $word_limit) { 
        array_pop($words); array_push($words, "..."); 

        echo '<p class="u-font-weight-bold u-color-folk-theme js-testimonial-read-more" data-value="' . $count . '">Ler mais</p>';
    }
}
...
acf_add_options_page( 
            array( 
                'page_title' => 'Nosso Impacto', 
                'menu_title' => 'Nosso Impacto', 
                'menu_slug'  => 'nosso_impacto', 
                'capability' => 'edit_posts', 
                'position'   => '23,5', 
                'redirect'   => false, 
